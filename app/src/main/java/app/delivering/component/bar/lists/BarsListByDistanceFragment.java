...
public class BarsListByDistanceFragment extends BaseFragment {
    ...
    private void initViews(View view) {
        BarsListBinder listBinder = new BarsListBinder(this, BarListFilterType.DISTANCE);
        addToEventBusAndViewInjection(listBinder, view);
        BarListItemClickBinder barListItemClickBinder = new BarListItemClickBinder(this, BarListFilterType.DISTANCE);
